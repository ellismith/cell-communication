#!/usr/bin/env python3
"""
Run LIANA pairwise analysis for the first individual using only the latest CellPhoneDB interaction CSV
"""
import os
import scanpy as sc
import pandas as pd
...
output_dir = "/scratch/easmit31/cell_cell/results/u01_first_individual_CPDB_interaction_only"
...
# Load only the interaction CSV from the latest CellPhoneDB
interaction_csv = "/scratch/easmit31/cell_cell/CellPhoneDB_latest/interaction_input_CellPhoneDB.csv"
custom_resource = {"interaction": pd.read_csv(interaction_csv)}
...
print("\nRunning LIANA with custom CellPhoneDB interaction CSV...")
