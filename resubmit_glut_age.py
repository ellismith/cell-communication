#!/usr/bin/env python3
"""Resubmit glutamatergic age-stratified jobs with 512GB"""
import os
import numpy as np
...
job_dir = "pairwise_jobs_with_age_glut_retry"
...
# Age bin thresholds (you'll need to adjust these - copying from original script)
young_max = 15.0  # Placeholder - adjust based on your data
old_min = 25.0    # Placeholder - adjust based on your data
...
print(f"Creating {len(glut_pairs)} age-stratified glutamatergic jobs with 512GB...")
...
print("="*70)
print("Analyzing {type1} ↔ {type2} (with age bins, 512GB)")
print("="*70)
...
#SBATCH --job-name={job_name}_age_512g
...
print(f"\\n✓ Submitted {len(glut_pairs)} age-stratified jobs with 512GB!")
