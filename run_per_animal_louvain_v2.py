...
assert len(cpdb_resource) == 2716, f"ERROR: expected 2716 LR pairs, got {len(cpdb_resource)}"
...
def run_animal_analysis(animal_id, region, output_dir=None):
    ...
    if output_dir is None:
        output_dir = "/scratch/easmit31/cell_cell/results/per_animal_louvain_v2"
...
if __name__ == "__main__":
    if len(sys.argv) not in (3, 4):
        print("Usage: python run_per_animal_louvain_v2.py <ANIMAL_ID> <REGION> [OUTPUT_DIR]")
        print("Example: python run_per_animal_louvain_v2.py 0B9 HIP")
        print("Example: python run_per_animal_louvain_v2.py 0B9 dlPFC /scratch/easmit31/cell_cell/results/per_animal_louvain_dlpfc_attempt2")
        sys.exit(1)
