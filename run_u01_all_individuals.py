#!/usr/bin/env python3
"""
Generate CellChat jobs for ALL individuals using proper complex handling (GENE1_GENE2 format)
with configurable expression proportion filtering
"""
import os
import pandas as pd
import argparse
...
# Parse arguments
parser = argparse.ArgumentParser(description='Generate CellChat jobs with configurable filtering')
...
output_dir = f"/scratch/easmit31/cell_cell/results/u01_per_individual{suffix}"
job_dir = f"/scratch/easmit31/cell_cell/u01_all_individuals_jobs{suffix}"
...
print("Loading CellPhoneDB interactions (2,909 with proper complex handling)...")
